    ...
    def add_floating_chat():
        ...
        with (
            ...
            scroll = ui.scroll_area().style(
                "flex: 1; min-height: 0; height: calc(100vh - 140px);"
            )
            with scroll:
                        ...
                        with chat_column:
                            if msg["role"] == "user":
                                ui.html(
                                    ...
                                    f'<div class="bubble-row-user"><div class="user-bubble">{msg["content"]}</div></div>',
                                ).classes("w-full")
                            else:
                                ui.html(
                                    sanitize=False,
                ...
                async def send():
                    ...
                    with chat_column:
                        ui.html(
                            ...
                            f'<div class="bubble-row-user"><div class="user-bubble">{query}</div></div>',
                        ).classes("w-full")
