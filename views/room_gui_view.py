...
class RoomGUIView:
    ...
    def room_add():
        ...
        with ui.column().classes('gap-6 items-center w-full'):
            ...
            ui.button("Save to Config").on("click", handle_add).props('rounded color=black text-color=white no-caps').classes('w-80 h-16 text-xl dark:!bg-white dark:!text-black')
            ui.button("Save").on("click", handle_add).props('rounded color=black text-color=white no-caps').classes('w-80 h-16 text-xl dark:!bg-white dark:!text-black')
    ...
    def room_modify():
        ...
        with ui.column().classes('gap-6 items-center w-full'):
            ...
            ui.button("Save to Config").on("click", handle_modify).props('rounded color=black text-color=white no-caps').classes('w-80 h-16 text-xl dark:!bg-white dark:!text-black')
            ui.button("Save").on("click", handle_modify).props('rounded color=black text-color=white no-caps').classes('w-80 h-16 text-xl dark:!bg-white dark:!text-black')
            ui.button('Back').props('rounded color=black text-color=white no-caps').classes('w-80 h-16 text-xl dark:!bg-white dark:!text-black').on('click', lambda: ui.navigate.to('/room'))
